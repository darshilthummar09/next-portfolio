...
export const metadata: Metadata = {
  ...
  "sparkle infotech","sparkleinfotech",
  "Darshil Thummar Sparkle Infotech",
  "Sparkle Infotech Developer",
  "Full Stack Developer at Sparkle Infotech",
  "MERN Stack Developer at Sparkle Infotech",
  "Sparkle Infotech MERN Developer",
  "Sparkle Infotech Web Developer",
  "Sparkle Infotech React Developer",
  "Sparkle Infotech Node.js Developer",
  "Darshil Thummar Sparkle Infotech Projects",
  "Sparkle Infotech Team Member",
  "Sparkle Infotech Web Application Developer",
  "Sparkle Infotech Software Developer",
  "Sparkle Infotech Full Stack Portfolio",
  "Best Developer at Sparkle Infotech",
  "Sparkle Infotech Projects and Solutions",
  "Sparkle Infotech Expert Developer",
  "Sparkle Infotech Web Development"
],
  openGraph: {
