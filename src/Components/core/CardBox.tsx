...
const CardBox = (props: Readonly<CoreComponentsProps>) => {
  ...
  return (
    <div
      ...
      onClick={onClick}
      ref={elementRef}
      className={`relative w-full flex flex-col duration-500 border rounded-[var(--borderRadius)] border-white/10 hover:border-[var(--primaryColor)] overflow-hidden group ${classNames}`}
    >
